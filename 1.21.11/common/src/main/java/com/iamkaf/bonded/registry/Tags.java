...
public class Tags {
    ...
    public static TagKey<Item> createItemTag(String namespace, String tag) {
        return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(namespace, tag));
    }

    public static TagKey<Block> createBlockTag(String namespace, String tag) {
        return TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(namespace, tag));
    }
}
