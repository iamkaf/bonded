...
public class DataComponents {
    ...
    public static final RegistrySupplier<DataComponentType<ItemLevelContainer>> ITEM_LEVEL_CONTAINER =
    ...
    public static final RegistrySupplier<DataComponentType<AppliedBonusesContainer>> APPLIED_BONUSES_CONTAINER =
            DATA_COMPONENT_TYPES.register(
