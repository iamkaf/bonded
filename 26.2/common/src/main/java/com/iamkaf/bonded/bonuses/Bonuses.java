...
public class Bonuses {
    public static void init() {
        ...
        GearManager.bondBonusRegistry.register(AttackDamageFactory.create(2000, 1));
        GearManager.bondBonusRegistry.register(AttackDamageFactory.create(5000, 1));
        GearManager.bondBonusRegistry.register(AttackDamageFactory.create(6000, 1));
        GearManager.bondBonusRegistry.register(AttackDamageFactory.create(7000, 1));
        GearManager.bondBonusRegistry.register(AttackDamageFactory.create(8000, 1));
        GearManager.bondBonusRegistry.register(AttackDamageFactory.create(9000, 1));
        GearManager.bondBonusRegistry.register(AttackDamageFactory.create(10000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(1000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(2000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(3000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(4000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(5000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(6000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(7000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(8000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(9000, 1));
        GearManager.bondBonusRegistry.register(DigSpeedFactory.create(10000, 1));
    }
}
