...
public class HUD {
    ...
    private static void renderRepairBenchInfo(GuiGraphics guiGraphics, Font textRenderer, int x, int y,
        ...
        if (stack.isEmpty() || repairIngredient == null) return;
        ...
        TooltipRenderUtil.renderTooltipBackground(guiGraphics, x, y, 20, 20, 20);
        guiGraphics.renderItem(repairIngredient.getItems()[0], x + 2, y + 2);
        guiGraphics.renderTooltip(mc.font,
                Screen.getTooltipFromItem(mc, repairIngredient.getItems()[0]),
    ...
    private static void renderToolBenchInfo(GuiGraphics guiGraphics, Font textRenderer, int x, int y,
        ...
        TooltipRenderUtil.renderTooltipBackground(guiGraphics, x, y, 16, 16, 20);
        guiGraphics.renderItem(upgradeIngredient.getItems()[0], x, y);
        TooltipRenderUtil.renderTooltipBackground(guiGraphics, x + 24, y, 16, 16, 20);
